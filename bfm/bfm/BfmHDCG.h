...
enum  LittleDopSolverType { LittleDopSolverMCR,LittleDopSolverCG,LittleDopSolverDeflCG, LittleDopSolverADef2 };
...
public:
 ...
 bfm_qdp<double> *linop_d;
 bfm_qdp<float>  *linop_f;
  ...
  template<class lFloat> void ComputeLittleMatrixColored (bfm_qdp<lFloat> *op,Fermion_t *subspace);
  template<class lFloat> void ComputeLittleMatrixColoredOneHopHermitian (bfm_qdp<lFloat> *op,Fermion_t *subspace);

  void MakeHermitian(std::vector<std::complex<cFloat> >& tmp1,std::vector<std::complex<cFloat> >&tmp2);

  void SinglePrecSubspace(void);

  double LittleDopSolverResidual;

  template<class Float> void RelaxSubspace(bfm_qdp<Float> *rop);
  template<class Float> void RationalSubspace(bfm_qdp<Float> *rop,Fermion_t src,Fermion_t sol);

  ///////////////////////////////////////////////////////
  // Cook up elegant multiprecision implementation.
  ///////////////////////////////////////////////////////
  Fermion_t *subspace_ro; // Orthogonalised subspace with relax Ls, relax precision
  ...
  std::vector<  std::complex<cFloat> > AdagSparse;
  ...
  template<class Float>   void PcgMlinop(Fermion_t in,Fermion_t out,Fermion_t tmp,bfm_qdp<Float> *lop,double shift,std::vector<double>&poly);
  ...
  template<class Float>   void PolyMdagMprec(bfm_qdp<Float> *lop,Fermion_t in,Fermion_t out,Chebyshev &Approx);
  template<class Float>   void PolyMdagMprec(bfm_qdp<Float> *lop,Fermion_t in,Fermion_t out,vector<double> & coeffs);
  template<class Float>   void SpectralDecomposition(Fermion_t psi,bfm_qdp<Float> *lop,const char *tag);
