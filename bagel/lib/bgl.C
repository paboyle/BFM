...
struct processor *create_bgl440 ()
{
  ...
  create_bgl440_instructions(proc);
  return(proc);
}
...
void create_bgl440_instructions( struct processor *proc)
{
  ...
  /*Define the hummer*/
  hummers[VMADD].mnemonic = "fpmadd ";
  hummers[VMSUB].mnemonic = "fpmsub ";
  hummers[VNMADD].mnemonic ="fpnmadd ";
  hummers[VNMSUB].mnemonic ="fpnmsub ";
  hummers[VMADD_RR_RI].mnemonic ="fxcpmadd ";
  hummers[VMADD_MII_IR].mnemonic ="fxcxnpma ";
  hummers[VMADD_II_MIR].mnemonic ="fxcxnsma ";

  hummers[VMUL].mnemonic = "fpmul ";
  hummers[VADD].mnemonic = "fpadd ";
  hummers[VSUB].mnemonic = "fpsub ";
  hummers[VNEG].mnemonic = "barf  ";
  hummers[VMUL_RR_RI].mnemonic ="fxpmul ";
  ...
  floads[CLOAD_INDEXED].mnemonic = "lfpdx  " ;
  floads[CSLOAD_INDEXED].mnemonic = "lfpsx  " ;
  for (i=0;i<nfloads;i++){
    floads[i].narg = 3;
  ...
  floads[CSLOAD_INDEXED].argtypes[1]=Iregs;

  fsaves[FSAVE_EA].mnemonic = "stfd " ;
  fsaves[FSAVE_REG_EA].mnemonic = "stfd " ;
  fsaves[CSAVE_INDEXED].mnemonic = "stfpdx " ;
  fsaves[FSSAVE_EA].mnemonic = "stfs " ;
  fsaves[CSSAVE_INDEXED].mnemonic = "stfpsx " ;
  for (i=0;i<nfsaves;i++){
    fsaves[i].narg = 3;
  ...
  fsaves[CSSAVE_INDEXED].argtypes[1]=Iregs;
